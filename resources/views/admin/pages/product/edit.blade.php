                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <select  id="user_type" type="text" name="user_type" class="form-control" required>
                                ...
                                <option value="admin" {{$data['user']->is_admin == 'admin' ? 'selected' : ''}}>Admin</option>
                                <option value="employee" {{$data['user']->is_admin =='employee' ? 'selected' : ''}}>Employee</option>
                                <option value="vendor" {{$data['user']->is_admin == 'vendor' ? 'selected' : ''}}>Vendor</option>
                            </select>
