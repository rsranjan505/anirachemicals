...
@section('title', 'User Vendors - Anira Chemicals')
    ...
    <div class="card-body">
        <div class="row gy-3">
            ...
            <div class="col-md-2">
                <div class="col-md">
                    <div class="form-check mt-3">
                        <form id="exportData" method="POST" action="{{ route('vendor.export')}}">
                            @csrf
    ...
    <div class="card-body">
        ...
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                @include('admin.pages.vendor.filter-vendor')
            </tbody>
        </table>
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            ...
            success:function(result, status, xhr){
                ...
                var filename = (matches != null && matches[1] ? matches[1] : 'vendor-report.csv');
