...
@section('title', 'Update Vendors - Anira Chemicals')
        ...
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ route('vendor.update',['vendor' => $vendor]) }}" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4" >
                        @if ($vendor->image !=null)
                            <img style="width: 100px;" id="avatarPreview" class="d-block rounded" src="{{$vendor->image->url }}" alt="Card image cap" />
                        @else
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name_of_establishment') is-invalid @enderror" id="name_of_establishment" name="name_of_establishment" value="{{ $vendor->name_of_establishment }}" placeholder="Name Of Establishment" />
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <select id="establishment_type" name="establishment_type" class="form-select @error('establishment_type') is-invalid @enderror">
                                ...
                                <option value="1" {{ $vendor->establishment_type == 1 ? 'selected' : ''}}>Individual</option>
                                <option value="2" {{ $vendor->establishment_type == 2 ? 'selected' : ''}}>LLP</option>
                                <option value="3" {{ $vendor->establishment_type == 3 ? 'selected' : ''}}>OPC</option>
                                <option value="4" {{ $vendor->establishment_type == 4 ? 'selected' : ''}}>Propietorship</option>
                                <option value="5" {{ $vendor->establishment_type == 5 ? 'selected' : ''}}>Partnership</option>
                                <option value="6" {{ $vendor->establishment_type == 6 ? 'selected' : ''}}>Pvt. Ltd.</option>
                                <option value="7" {{ $vendor->establishment_type == 7 ? 'selected' : ''}}>Ltd.</option>
                                <option value="8" {{ $vendor->establishment_type == 8 ? 'selected' : ''}}>Other</option>
                            </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('key_person') is-invalid @enderror" id="key_person" name="key_person" value="{{ $vendor->key_person }}" placeholder="Key Person Name" />
                    @error('key_person')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ $vendor->email }}" placeholder="Email" />
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-xl-6 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('mobile') is-invalid @enderror" id="mobile" name="mobile" value="{{ $vendor->mobile }}" placeholder="Mobile" />
                            @error('mobile')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="mb-3">
                    <div class="mb-3">
                        ...
                        <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror" placeholder="Address">{{ $vendor->address }}</textarea>
                        @error('address')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="mb-3">
                            ...
                            <select id="city_id" name="city_id" class="form-select @error('city_id') is-invalid @enderror">
                                ...
                                @foreach ($cities->where('state_id',$vendor->state_id) as $city)
                    ...
                    <div class="col-xl-4 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{$vendor->pincode}}" class="form-control @error('pincode') is-invalid @enderror" id="pincode" name="pincode" placeholder="Pincode" />
                            @error('pincode')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('description') is-invalid @enderror" id="description" name="description" value="{{ $vendor->description }}" placeholder="Description" />
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
